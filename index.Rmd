...
t(table(cow.level.df$parity)) %>% knitr::kable(col.names = c("Parity 1","Parity 2",
    "Parity 3","Parity 4","Parity 5","Parity 6","Parity 7"),
                           caption = "Number of cows enrolled in study", align = 'ccccccc')
...
t(table(df$dim)) %>% knitr::kable(col.names = c("3 DIM","4 DIM","5 DIM","6 DIM","7 DIM","8 DIM","9 DIM","10 DIM"),
                           caption = "Number of samples at each DIM", align = 'cccccccc')
...
### Number of healthy and sick cows

```{r, echo=F}

cow.level.df2 = df %>% group_by(cow_id) %>% 
  summarise(sick = mean(sick))

t(table(cow.level.df2$sick)) %>% knitr::kable(col.names = c("Healthy","Sick"),
                           caption = "Number of healthy and sick cows", align = 'cc')
...
t(AUC) %>% knitr::kable(col.names = c("3 DIM","4 DIM","5 DIM","6 DIM","7 DIM","8 DIM","9 DIM","10 DIM"),
                           caption = "Area under ROC curve for PLS model at each DIM", align = 'cccccccc')
