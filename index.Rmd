...
All statistical analyses, data manipulation, and visualization was completed using the statistical software, R (version 4.1.2). The following R packages were used: tidyr, dplyr, ggplot2, readr, cutpointr, pls, car, caret, plotROC, knitr, epiR, kableExtra, and pROC.
...
t(table(cow.level.df$parity)) %>% kable(col.names = c("Parity 1","Parity 2",
...
t(table(df$dim)) %>% kable(col.names = c("3 DIM","4 DIM","5 DIM","6 DIM","7 DIM","8 DIM","9 DIM","10 DIM"),
...
t(AUC) %>% kable(col.names = c("3 DIM","4 DIM","5 DIM","6 DIM","7 DIM","8 DIM","9 DIM","10 DIM"),
